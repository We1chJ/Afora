        ...
        schema: {
            ...
            properties: {
                stages: {
                    type: "array",
                    description:
                        "A list of stages, each containing a list of tasks.",
                    items: {
                        type: "object",
                        properties: {
                            stage_name: {
                            ...
                            tasks: {
                                type: "array",
                                description:
                                    "A list of tasks associated with this stage.",
                                items: {
                                    type: "object",
                                    properties: {
                                        task_name: {
                                        ...
                                        soft_deadline: {
                                            type: "string",
                                            description:
                                                "The first soft deadline for the task",
                                        },
                                        hard_deadline: {
                                            type: "string",
                                            description:
                                                "The final hard deadline for the task",
                                        },
                                    },
                                    required: [
                                        "task_name",
