...
const CommentBox: React.FC<CommentBoxProps> = ({
    ...
    return (
        <div
            className={`relative w-full max-w-full quill-comment-container`}
            ref={quillRef}
        >
            <style jsx global>{`
            ...
            >
                ...
                <div className="flex-1 min-w-0 relative z-50">
                    <div
                        className={`${isFocused ? "toolbar-visible" : ""} flex flex-col transition-all duration-200 w-full min-w-0`}
                    >
                        <ReactQuill
                            theme="snow"
                            value={comment}
