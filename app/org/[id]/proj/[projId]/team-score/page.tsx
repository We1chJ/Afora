...
function TeamScorePage({ params: { id, projId } }: {
  params: {
    id: string;
    projId: string;
  }
  ...
  const loadMockData = () => {
    ...
    setProjectMembers(mockProjectMembers[projId as keyof typeof mockProjectMembers] || []);
    setLoading(false);
  };
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Track and analyze your project team's performance metrics and collaboration scores.
        </p>
      </div>
