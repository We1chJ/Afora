    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Use mock team data to analyze team compatibility through real GPT API
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              <h3 className="font-medium mb-2">Test Team Members:</h3>
            ...
            <div className="text-sm text-muted-foreground">
              <p>• Alice: Frontend Development Expert (React, TypeScript, UI/UX Design)</p>
              <p>• Bob: Backend Architect (Node.js, PostgreSQL, Docker, AWS)</p>
              <p>• Charlie: Project Manager (Project Management, Scrum, Business Analysis)</p>
              <p>• David: Test Engineer (Testing, Quality Assurance, Automation)</p>
            </div>
          </div>
        </CardContent>
      </Card>
